...
-- -----------------------------------------------------
-- Table `Crrow`.`Contents_Category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Crrow`.`Contents_Category` (
...
CREATE TABLE IF NOT EXISTS `Crrow`.`Room` (
  ...
  `Question_question_id` INT UNSIGNED NULL,
...
CREATE TABLE IF NOT EXISTS `Crrow`.`Question_Category` (
  `Question_question_id` INT UNSIGNED NOT NULL,
...
-- Table `Crrow`.`Like`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `Crrow`.`Like` (
  `User_id` INT UNSIGNED NOT NULL,
  `Room_id` INT NOT NULL,
